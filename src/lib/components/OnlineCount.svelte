...
{#if counts.connected}
	<div class="group fixed top-5 right-6" aria-live="polite" aria-label="Live spectator count">
		...
		<div
			role="tooltip"
			class="pointer-events-none absolute top-full right-0 origin-top-right rounded-md bg-stone-700 px-2 text-xs font-medium whitespace-nowrap text-white opacity-0 shadow-lg transition-opacity duration-150 group-hover:opacity-100"
		>
